...
<?php require_once __DIR__."/../functions/outputMissingLetters.php"; outputMissingLetters("лр"); ?>
<script type="text/javascript">function open_letter_section(){ window.location = '/medicalenglishtest/letter-section.php'; }</script> 
<script src="/medicalenglishtest/js/link-next.js"></script>
<?php require("../parts/link-bottom.php"); ?>
<script src="/medicalenglishtest/js/modal-window.js"></script>
<script src="/medicalenglishtest/js/missing-letter.js"></script>
</body>
</html>